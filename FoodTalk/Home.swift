...
class Home: UIViewController, UIActionSheetDelegate, UITableViewDataSource, UITableViewDelegate, WebServiceCallingDelegate, CLUploaderDelegate, FloatRatingViewDelegate, UITabBarControllerDelegate, TTTAttributedLabelDelegate, UISearchBarDelegate {
...
//        }
    ...
    override func viewWillAppear(animated: Bool) {
      ...
      //  self.title = "Home"
        ...
        searchBar.placeholder = "Search dishes, users, restaurants"
