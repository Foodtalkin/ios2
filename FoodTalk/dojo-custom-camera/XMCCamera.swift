...
class XMCCamera: NSObject {
    ...
    func setObservers() {
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(XMCCamera.sessionDidStart(_:)), name: AVCaptureSessionDidStartRunningNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(XMCCamera.sessionDidStop(_:)), name: AVCaptureSessionDidStopRunningNotification, object: nil)
    }
