...
class FoodTalkSuggestionsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, WebServiceCallingDelegate,CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Food Talk curated list"
    }
